 ...
 */
@Deprecated
public final class UdpDataSourceCustom extends BaseDataSource {
...
//    }
     ...
     */
    public UdpDataSourceCustom(int maxPacketSize) {
     ...
     */
    public UdpDataSourceCustom(int maxPacketSize, int socketTimeoutMillis) {
    ...
    @Override
    public long open(DataSpec dataSpec) throws com.google.android.exoplayer2.upstream.UdpDataSource.UdpDataSourceException {
        uri = dataSpec.uri;
        ...
        try {
            ...
            if (address.isMulticastAddress()) {
                ...
                multicastSocket.setNetworkInterface(NetworkInterface.getByName("eth0.796"));
...
//            throw new com.google.android.exoplayer2.upstream.UdpDataSource.UdpDataSourceException();
        } catch (IOException e) {
            throw new com.google.android.exoplayer2.upstream.UdpDataSource.UdpDataSourceException(
                    e);
        }
    ...
    @Override
    public int read(byte[] buffer, int offset, int length) throws com.google.android.exoplayer2.upstream.UdpDataSource.UdpDataSourceException {
        if (length == 0) {
            return 0;
        }
